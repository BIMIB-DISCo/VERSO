...
#' @docType data
#' @usage data(variants)
#' @format SARS-CoV-2 variants
#' @source NCBI BioProject PRJNA610428
#' @return SARS-CoV-2 variants
NULL
...
#' @return results obtained running VERSO on the provided input dataset
NULL
