...
# RUNNING
To run the tools for VERSO STEP #1 and STEP #2, please open the folders named _*VERSO_STEP_1*_ and _*VERSO_STEP_2_* and refer to the related readme, which includes instructions and guidelines. 
